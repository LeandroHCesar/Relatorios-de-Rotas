...
class RotasViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(rota: RotaData) {
        ...
        val valorAdicional = "Adicional: ${formatValorEmReais(rota.adicionalCentavos)}"
        val valorDiaria = "Diária: ${formatValorEmReais(rota.diariaCentavos)}"
        val valorComb = "Combustível: ${formatValorEmReais(rota.combustivelCentavos)}"
        val valorPedagio = "Pedágio: ${formatValorEmReais(rota.pedagioCentavos)}"
        ...
        textAdicional.text = valorAdicional
        textDiaria.text = valorDiaria
        textCombustivel.text = valorComb
        textPedagio.text = valorPedagio
        textkm.text = numKM
    }
